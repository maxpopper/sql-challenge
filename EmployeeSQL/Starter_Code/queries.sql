...
-- List the emp_no, last_name, first_name, sex, and salary of each employee 
...
-- List the manager of each dept along with their dept_no, dept_name, emp_no, last_name, and first_name
SELECT dm.dept_no,
		dm.emp_no,
		d.dept_name,
		e.last_name,
...
-- List the dept_no for each employee along with that employee’s emp_no, last_name, first_name, and dept_name
SELECT de.dept_no, 
		de.emp_no, 
		e.last_name,
		e.first_name,
...
-- List first_name, last_name, and sex of each employee whose first name is Hercules 
...
-- List each employee in the Sales department, including their emp_no, last_name, and first_name
SELECT d.dept_name, 
		de.emp_no, 
		e.last_name, 
		e.first_name
